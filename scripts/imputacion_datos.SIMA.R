...
imputacion.datos.SIMA <- function(x, tabla.historica, actualizar = TRUE, modelos.dir = "R/modelos de imputacion"){
  ##1. ozono
...
#  print(ls(modelos.imputacion))
  ...
  if(any(is.na(obispado$O3))){
    ...
    imputacion.O3.obispado <- imputacion.univ(modelos.imputacion$arima.O3.obispado.imp, O3.obispado.nuevo, O3.obispado.historico)
  ...
  if(any(is.na(catarina$O3))){ 
    ...
    imputacion.O3.catarina <- imputacion.univ(modelos.imputacion$arima.O3.catarina.imp, O3.catarina.nuevo, O3.catarina.historico)
  ...
  if(any(is.na(bernabe$O3))){
    ...
    imputacion.O3.bernabe <- imputacion.univ(modelos.imputacion$arima.O3.bernabe.imp, O3.bernabe.nuevo, O3.bernabe.historico)
  ...
  if(any(is.na(nicolas$O3))){
    ...
    imputacion.O3.nicolas <- imputacion.univ(modelos.imputacion$arima.O3.nicolas.imp, O3.nicolas.nuevo, O3.nicolas.historico)
  ...
  if(any(is.na(pastora$O3))){
    ...
    imputacion.O3.pastora <- imputacion.univ(modelos.imputacion$arima.O3.pastora.imp, O3.pastora.nuevo, O3.pastora.historico)
...
#   obispado <- x[x$sitio == "Obispado", ]
  ...
  if(any(is.na(obispado$PM10))){
    ...
    imputacion.PM10.obispado <- imputacion.univ(modelos.imputacion$arima.PM10.obispado.imp, PM10.obispado.nuevo, PM10.obispado.historico)
...
#   catarina <- x[x$sitio == "Santa Catarina", ]
  ...
  if(any(is.na(catarina$PM10))){
    ...
    imputacion.PM10.catarina <- imputacion.univ(modelos.imputacion$arima.PM10.catarina.imp, PM10.catarina.nuevo, PM10.catarina.historico)
...
#   bernabe <- x[x$sitio == "San Bernabe", ]
  ...
  if(any(is.na(bernabe$PM10))){
    ...
    imputacion.PM10.bernabe <- imputacion.univ(modelos.imputacion$arima.PM10.bernabe.imp, PM10.bernabe.nuevo, PM10.bernabe.historico)
...
#   nicolas <- x[x$sitio == "San Nicolas", ]
  ...
  if(any(is.na(nicolas$PM10))){
    ...
    imputacion.PM10.nicolas <- imputacion.univ(modelos.imputacion$arima.PM10.nicolas.imp, PM10.nicolas.nuevo, PM10.nicolas.historico)
...
#   pastora <- x[x$sitio == "La Pastora", ]
  ...
  if(any(is.na(pastora$PM10))){
    ...
    imputacion.PM10.pastora <- imputacion.univ(modelos.imputacion$arima.PM10.pastora.imp, PM10.pastora.nuevo, PM10.pastora.historico)
...
#   obispado <- x[x$sitio == "Obispado", ]
  ...
  if(any(is.na(obispado$HR))){
    ...
    imputacion.HR.obispado <- imputacion.univ(modelos.imputacion$obispado.arima.hr.imp, HR.obispado.nuevo, HR.obispado.historico)
...
#   obispado <- x[x$sitio == "Obispado", ]
  ...
  if(any(is.na(obispado$SR))){
    ...
    imputacion.SR.obispado <- imputacion.univ(modelos.imputacion$obispado.arima.sr.imp, SR.obispado.nuevo, SR.obispado.historico)
...
#   obispado <- x[x$sitio == "Obispado", ]
  ...
  if(any(is.na(obispado$WS))){
    ...
    imputacion.WS.obispado <- imputacion.univ(modelos.imputacion$obispado.arima.ws.imp, WS.obispado.nuevo, WS.obispado.historico)
...
#   obispado <- x[x$sitio == "Obispado", ]
  ...
  if(any(is.na(obispado$TOUT))){
    ...
    imputacion.TOUT.obispado <- imputacion.univ(modelos.imputacion$obispado.arima.tout.imp, TOUT.obispado.nuevo, TOUT.obispado.historico)
...
#   obispado <- x[x$sitio == "Obispado", ]
  ...
  if(any(is.na(obispado$WDR))){
    ...
    imputacion.SIN.WDR.obispado <- imputacion.univ(modelos.imputacion$obispado.arima.sin.wdr.imp, WDR.obispado.nuevo, WDR.obispado.historico)
    imputacion.COS.WDR.obispado <- imputacion.univ(modelos.imputacion$obispado.arima.cos.wdr.imp, WDR.obispado.nuevo, WDR.obispado.historico)
...
#   catarina <- x[x$sitio == "Santa Catarina", ]
  ...
  if(any(is.na(catarina$HR))){
    ...
    imputacion.HR.catarina <- imputacion.univ(modelos.imputacion$catarina.arima.hr.imp, HR.catarina.nuevo, HR.catarina.historico)
...
#   catarina <- x[x$sitio == "Santa Catarina", ]
  ...
  if(any(is.na(catarina$SR))){
    ...
    imputacion.SR.catarina <- imputacion.univ(modelos.imputacion$catarina.arima.sr.imp, SR.catarina.nuevo, SR.catarina.historico)
...
#   catarina <- x[x$sitio == "Santa Catarina", ]
  ...
  if(any(is.na(catarina$WS))){
    ...
    imputacion.WS.catarina <- imputacion.univ(modelos.imputacion$catarina.arima.ws.imp, WS.catarina.nuevo, WS.catarina.historico)
...
#   catarina <- x[x$sitio == "Santa Catarina", ]
  ...
  if(any(is.na(catarina$TOUT))){
    ...
    imputacion.TOUT.catarina <- imputacion.univ(modelos.imputacion$catarina.arima.tout.imp, TOUT.catarina.nuevo, TOUT.catarina.historico)
...
#   catarina <- x[x$sitio == "Santa Catarina", ]
  ...
  if(any(is.na(catarina$WDR))){
    ...
    imputacion.SIN.WDR.catarina <- imputacion.univ(modelos.imputacion$catarina.arima.sin.wdr.imp, WDR.catarina.nuevo, WDR.catarina.historico)
    imputacion.COS.WDR.catarina <- imputacion.univ(modelos.imputacion$catarina.arima.cos.wdr.imp, WDR.catarina.nuevo, WDR.catarina.historico)
...
#   bernabe <- x[x$sitio == "San Bernabe", ]
  ...
  if(any(is.na(bernabe$HR))){
    ...
    imputacion.HR.bernabe <- imputacion.univ(modelos.imputacion$bernabe.arima.hr.imp, HR.bernabe.nuevo, HR.bernabe.historico)
...
#   bernabe <- x[x$sitio == "San Bernabe", ]
  ...
  if(any(is.na(bernabe$SR))){
    ...
    imputacion.SR.bernabe <- imputacion.univ(modelos.imputacion$bernabe.arima.sr.imp, SR.bernabe.nuevo, SR.bernabe.historico)
...
#   bernabe <- x[x$sitio == "San Bernabe", ]
  ...
  if(any(is.na(bernabe$WS))){
    ...
    imputacion.WS.bernabe <- imputacion.univ(modelos.imputacion$bernabe.arima.ws.imp, WS.bernabe.nuevo, WS.bernabe.historico)
...
#   bernabe <- x[x$sitio == "San Bernabe", ]
  ...
  if(any(is.na(bernabe$TOUT))){
    ...
    imputacion.TOUT.bernabe <- imputacion.univ(modelos.imputacion$bernabe.arima.tout.imp, TOUT.bernabe.nuevo, TOUT.bernabe.historico)
...
#   bernabe <- x[x$sitio == "San Bernabe", ]
  ...
  if(any(is.na(bernabe$WDR))){
    ...
    imputacion.SIN.WDR.bernabe <- imputacion.univ(modelos.imputacion$bernabe.arima.sin.wdr.imp, WDR.bernabe.nuevo, WDR.bernabe.historico)
    imputacion.COS.WDR.bernabe <- imputacion.univ(modelos.imputacion$bernabe.arima.cos.wdr.imp, WDR.bernabe.nuevo, WDR.bernabe.historico)
...
#   nicolas <- x[x$sitio == "San Nicolas", ]
  ...
  if(any(is.na(nicolas$HR))){
    ...
    imputacion.HR.nicolas <- imputacion.univ(modelos.imputacion$nicolas.arima.hr.imp, HR.nicolas.nuevo, HR.nicolas.historico)
...
#   nicolas <- x[x$sitio == "San Nicolas", ]
  ...
  if(any(is.na(nicolas$SR))){
    ...
    imputacion.SR.nicolas <- imputacion.univ(modelos.imputacion$nicolas.arima.sr.imp, SR.nicolas.nuevo, SR.nicolas.historico)
...
#   nicolas <- x[x$sitio == "San Nicolas", ]
  ...
  if(any(is.na(nicolas$WS))){
    ...
    imputacion.WS.nicolas <- imputacion.univ(modelos.imputacion$nicolas.arima.ws.imp, WS.nicolas.nuevo, WS.nicolas.historico)
...
#   nicolas <- x[x$sitio == "San Nicolas", ]
  ...
  if(any(is.na(nicolas$TOUT))){
    ...
    imputacion.TOUT.nicolas <- imputacion.univ(modelos.imputacion$nicolas.arima.tout.imp, TOUT.nicolas.nuevo, TOUT.nicolas.historico)
...
#   nicolas <- x[x$sitio == "San Nicolas", ]
  ...
  if(any(is.na(nicolas$WDR))){
    ...
    imputacion.SIN.WDR.nicolas <- imputacion.univ(modelos.imputacion$nicolas.arima.sin.wdr.imp, WDR.nicolas.nuevo, WDR.nicolas.historico)
    imputacion.COS.WDR.nicolas <- imputacion.univ(modelos.imputacion$nicolas.arima.cos.wdr.imp, WDR.nicolas.nuevo, WDR.nicolas.historico)
...
#   pastora <- x[x$sitio == "La Pastora", ]
  ...
  if(any(is.na(pastora$HR))){
    ...
    imputacion.HR.pastora <- imputacion.univ(modelos.imputacion$pastora.arima.hr.imp, HR.pastora.nuevo, HR.pastora.historico)
...
#   pastora <- x[x$sitio == "La Pastora", ]
  ...
  if(any(is.na(pastora$SR))){
    ...
    imputacion.SR.pastora <- imputacion.univ(modelos.imputacion$pastora.arima.sr.imp, SR.pastora.nuevo, SR.pastora.historico)
...
#   pastora <- x[x$sitio == "La Pastora", ]
  ...
  if(any(is.na(pastora$WS))){
    ...
    imputacion.WS.pastora <- imputacion.univ(modelos.imputacion$pastora.arima.ws.imp, WS.pastora.nuevo, WS.pastora.historico)
...
#   pastora <- x[x$sitio == "La Pastora", ]
  ...
  if(any(is.na(pastora$TOUT))){
    ...
    imputacion.TOUT.pastora <- imputacion.univ(modelos.imputacion$pastora.arima.tout.imp, TOUT.pastora.nuevo, TOUT.pastora.historico)
...
#   pastora <- x[x$sitio == "La Pastora", ]
  ...
  if(any(is.na(pastora$WDR))){
    ...
    imputacion.SIN.WDR.pastora <- imputacion.univ(modelos.imputacion$pastora.arima.sin.wdr.imp, WDR.pastora.nuevo, WDR.pastora.historico)
    imputacion.COS.WDR.pastora <- imputacion.univ(modelos.imputacion$pastora.arima.cos.wdr.imp, WDR.pastora.nuevo, WDR.pastora.historico)
...
mimp.kalman.Arima.imp <- function(x, ...){
  ...
  aux <- apply(aux[which(Z!=0), ], 2, sum) + int
...
imputacion.univ <- function(x, ...)
  UseMethod("imputacion.univ")
  
imputacion.univ.default <- function(x, serie, modelo, funcion){ #x el periodo, serie la serie historica, modelo el modelo Arima.imp. funcion (generica que produce la imputacion)
...
imputacion.univ.Arima.imp <- function(modelo, x, serie){ #x el periodo, serie la serie historica, modelo el modelo Arima.imp. funcion (generica que produce la imputacion)
  if(is.null(modelo$trans) | is.null(modelo$trans.inv)) stop("'modelo' no contiene la transformacion o transformacion inversa.")
  modelo$serie <- modelo$trans(c(serie, x))
